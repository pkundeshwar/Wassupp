(function() {
	...
	var greenAlertError = {
		template : '<div class="alerts" ng-cloak="" role="alert">'
				...
				+ '</div>' + '</div>',
		controller : greenAlertErrorController
	};

	angular.module('greenFurniture').component('greenAlertError', greenAlertError);
	greenAlertErrorController.$inject = [ '$scope', 'AlertService', '$rootScope' ];

	function greenAlertErrorController($scope, AlertService, $rootScope) {
		var vm = this;
		...
		$scope.$on('$destroy', function() {
			if (angular.isDefined(cleanHttpErrorListener)
