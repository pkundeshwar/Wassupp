(function() {
	'use strict';
	angular.module('greenFurniture').provider('AlertService', AlertService);
	...
	function AlertService() {
		...
		function getService($timeout, $sce) {
			var toast = this.toast, alertId = 0, // unique id for each alert. Starts from 0.
			...
			function factory(alertOptions) {
				var alert = {
					...
					position : alertOptions.position ? alertOptions.position
							: 'top right',
