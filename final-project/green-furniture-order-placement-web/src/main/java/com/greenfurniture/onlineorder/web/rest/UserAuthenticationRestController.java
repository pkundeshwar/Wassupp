...
import com.greenfurniture.onlineorder.dto.LoginDto;
...
public class UserAuthenticationRestController {
	...
	private static final Logger LOG = LoggerFactory.getLogger(UserAuthenticationRestController.class);

	private final TokenProvider tokenProvider;

	private final AuthenticationManager authenticationManager;

	public UserAuthenticationRestController(TokenProvider tokenProvider, AuthenticationManager authenticationManager) {
